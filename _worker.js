...
// 建议修改为自己的 UUID
let userID = 'f74cae78-b767-4233-8d8e-622348fcc49c';

// 生成配置文件的 CF 优选 IP
const bestCFIP = "www.gov.se"

// 用于 CF 网站的代理 IP
const proxyIPs = ["cdn-all.xn--b6gac.eu.org"]; // const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
